...
#     thereof.
#
# Description:  compiler options for AUTOSAR benchmark
#
#################################################################
...
cpopt       := -DOSGHSARM -I$(cinc) -I$(clib) -I$(clibinc) -I$(ceabinc) -I$(OTHER_INCLUDES) -D$(CHIPS) -DSCGINIT

asopt       := -cpu=$(proc) -c -preprocess_assembly_files -asm=-list -D__STACK_SIZE=0x1000 -fhard -fpu=vfpv4_d16
...
ccopt := -c -O1 -ggdb3 -mcpu=$(proc) -mthumb -mlittle-endian -fomit-frame-pointer -mhard-float -fno-common \
         -Wall -Wextra -Wstrict-prototypes -Wno-sign-compare -Werror=implicit-function-declaration -mfloat-abi=hard -mfpu=fpv4-sp-d16

# Preprocessor options
cpopt := -DOSGCCARM -I$(cinc) -I$(clib) -I$(clibinc) -I$(ceabinc) -I$(OTHER_INCLUDES) -D$(CHIPS) -DSCGINIT

# Assembler options
asopt := -mcpu=$(proc) -c -mthumb -x assembler-with-cpp -D__STACK_SIZE=0x1000 -mfloat-abi=hard -mfpu=fpv4-sp-d16
#-DOSPROPH="\"$(OS_PROPHEADER)\""

# Linker options
ldopt  = -T $(LINKER_CMD_OUTFILE) -Map $(bin_output_path)/$(projname)_$(suff).map -L $(clib) -L $(ceablib) $(FILES_TO_LINK)
...
# Preprocessor options
cpopt := -DOSDS5ARM -I$(cinc) -I$(clib) -I$(clibinc) -I$(ceabinc) -I$(OTHER_INCLUDES) -D$(CHIPS)
...
# Linker options
# $(clib) $(ceablib)
ldopt  = --cpu=$(proc) --library_type=microlib --info unused --symbols --entry Reset_Handler --scatter $(LINKER_CMD_OUTFILE) --map --list=$(bin_output_path)/$(projname)_$(suff).map $(FILES_TO_LINK)
...
# Preprocessor options
cpopt := -DOSIARARM -I$(cinc) -I$(clib) -I$(clibinc) -I$(ceabinc) -I$(OTHER_INCLUDES) -D$(CHIPS) -DSCGINIT
...
# Linker options
# $(clib) 
ldopt  = --no_wrap_diagnostics --skip_dynamic_initialization -L $(ceablib) --config $(LINKER_CMD_OUTFILE) --map $(bin_output_path)/$(projname)_$(suff).map $(FILES_TO_LINK)
