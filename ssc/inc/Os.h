...
#if !defined(OSDISABLE_AUTOSAR_VERSION_CHECK)
...
#endif
#endif /* defined(OSDISABLE_AUTOSAR_VERSION_CHECK) */
...
#if ((OS_AR_RELEASE_MAJOR_VERSION != RTE_OS_TYPE_AR_RELEASE_MAJOR_VERSION) || \
     (OS_AR_RELEASE_MINOR_VERSION != RTE_OS_TYPE_AR_RELEASE_MINOR_VERSION))
