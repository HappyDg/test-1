...
typedef OSTASKTYPE (*OSTASKENTRY) (void);
	...
	#if defined(OSTSKFPU)
		#define OSJBLEN         (25)  /**< LONG LONG space for 16 integer registers (32bit per register) and 17 (64bit per register) D0 - D15, FPSCR registers */
	#else
		#define OSJBLEN         (16)
	#endif /* OSTSKFPU */
...
/*  Contexts of tasks */
#if defined(OSTSKFPU)
typedef OSQWORD OSJMP_BUF[OSJBLEN];
typedef OSQWORD *OSJMP_BUFPTR;
#else
