...
OSISRSystemTimer (void)
{
    ...
    #if defined(OSTIMSTM) || defined(OSTIMSTM1) || defined(OSTIMSTM2)
    TickType Tcnt;
    #endif
    ...
    again:
        ...
        #endif /* defined(OSTIMSTM) || defined(OSTIMSTM1) || defined(OSTIMSTM2) */
...
OSISRSecondTimer (void)
{
    ...
    #if defined(OSTIM2STM) || defined(OSTIM2STM1) || defined(OSTIM2STM2)
    TickType Tcnt;
    #endif
    ...
    again:
        ...
        #endif /* defined(OSTIM2STM) || defined(OSTIM2STM1) || defined(OSTIM2STM2) */
 ...
 ******************************************************************************/
OSINLINE TickType
OSSCGetCounterValue (OSWORD ctrId)
{
    ...
    #endif
    {
        return ((TickType) OSSWCtrValue (ctrId));
    }
    #endif /* defined(OSSWCOUNTER) */
    #if defined(OSHWCOUNTER)
    #if defined(OSSWCOUNTER)
    ...
    #endif /* defined(OSSWCOUNTER) */
    {
        return ((TickType) OSHWCtrValue (ctrId));
    }
    #endif /* defined(OSHWCOUNTER) */
}
...
OS_GetCounterValue (CounterType ctrId, TickRefType tickRef)
{
...

    {
        ...
        *tickRef = OSSCGetCounterValue (ctrInd);
                           ...
                           TickRefType tickRef)
{
...

    {
        ...
        currentValue = OSSCGetCounterValue (ctrInd);
    }
